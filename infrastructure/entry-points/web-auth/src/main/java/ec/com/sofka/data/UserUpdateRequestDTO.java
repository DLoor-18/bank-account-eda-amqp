...
public class UserUpdateRequestDTO implements Serializable {
    @Schema(description = "aggregateId of user", example = "123")
    ...
    public UserUpdateRequestDTO(String aggregateId, String email, String password, String firstName, String lastName, String userRole) {
